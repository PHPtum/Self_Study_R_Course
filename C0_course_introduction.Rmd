...
The time you will need for a particular chapter and the whole SSRC depends on your programming experience, talent, accuracy, pragmatism etc. This means that it is impossible to make a general statement regarding time requirements. However, to facilitate better planning for you, we at least provide a rough time estimate for each of the chapters below. If you need more time for one or the other chapter, you should not feel bad about it, though. 
