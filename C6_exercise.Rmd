...
### Task 2
Download the csv-file [_SSRC_data.csv_](data/SSRC_data.csv) and the R script [_SSRC_C6_template.R_](templates/SSRC_C6_template.R) and put it in the R project folder you created in Task 1.
